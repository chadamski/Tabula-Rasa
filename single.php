<?php get_header(); ?>
	...
	<?php if (have_posts()): while (have_posts()) : the_post(); ?>
		...
		<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
			...
			<?php the_tags( __( 'Tags: ', 'Tabula Rasa' ), ', ', '<br>'); // Separated by commas with a line break at the end ?>

			<p><?php _e( 'Categorised in: ', 'Tabula Rasa' ); the_category(', '); // Separated by commas ?></p>
